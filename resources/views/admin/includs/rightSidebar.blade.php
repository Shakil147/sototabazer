                      ...
                      <ul class="chat-list-wrap">
                        <li class="chat-list">
                          <div class="chat-body"> <a href="javascript:void(0)">
                            <div class="chat-data"> <img class="user-img img-circle"  src="{{ asset('backend') }}/plugins/assets/img/users/avatar-2.jpg" alt="user"/>
                            ...
                            <div class="chat-data"> <img class="user-img img-circle"  src="{{ asset('backend') }}/plugins/assets/img/users/avatar-1.jpg" alt="user"/>
                            ...
                            <div class="chat-data"> <img class="user-img img-circle"  src="{{ asset('backend') }}/plugins/assets/img/users/avatar-3.jpg" alt="user"/>
                            ...
                            <div class="chat-data"> <img class="user-img img-circle"  src="{{ asset('backend') }}/plugins/assets/img/users/avatar-4.jpg" alt="user"/>
                            ...
                            <div class="chat-data"> <img class="user-img img-circle"  src="{{ asset('backend') }}/plugins/assets/img/users/avatar-5.jpg" alt="user"/>
                      ...
                      <div class="panel-body pa-0">
                        <div class="chat-content">
                          <ul class="nicescroll-bar pt-20">
                            <li class="friend">
                              <div class="friend-msg-wrap"> <img class="user-img img-circle block pull-left"  src="{{ asset('backend') }}/plugins/assets/img/users/avatar-2.jpg" alt="user"/>
              ...
              <div class="message-box-wrap">
                ...
                <div class="set-height-wrap">
                  <div class="streamline message-box nicescroll-bar"> <a href="javascript:void(0)">
                    <div class="sl-item">
                      <div class="sl-avatar avatar avatar-sm avatar-circle"> <img class="img-responsive img-circle" src="{{ asset('backend') }}/plugins/assets/img/users/avatar-2.jpg" alt="avatar"/> </div>
                    ...
                    <div class="sl-item">
                      <div class="sl-avatar avatar avatar-sm avatar-circle"> <img class="img-responsive img-circle" src="{{ asset('backend') }}/plugins/assets/img/users/avatar-1.jpg" alt="avatar"/> </div>
                    ...
                    <div class="sl-item">
                      <div class="sl-avatar avatar avatar-sm avatar-circle"> <img class="img-responsive img-circle" src="{{ asset('backend') }}/plugins/assets/img/users/avatar-3.jpg" alt="avatar"/> </div>
                    ...
                    <div class="sl-item">
                      <div class="sl-avatar avatar avatar-sm avatar-circle"> <img class="img-responsive img-circle" src="{{ asset('backend') }}/plugins/assets/img/users/avatar-4.jpg" alt="avatar"/> </div>
                    ...
                    <div class="sl-item">
                      <div class="sl-avatar avatar avatar-sm avatar-circle"> <img class="img-responsive img-circle" src="{{ asset('backend') }}/plugins/assets/img/users/avatar-5.jpg" alt="avatar"/> </div>
