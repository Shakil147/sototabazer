<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="mobile-only-brand pull-left">
      <div class="nav-header pull-left">
        <div class="logo-wrap"> <a href="{{ url('/home') }}"> <img class="brand-img" src="{{ asset('backend') }}/plugins/assets/img/logo.png" alt="brand"/> <span class="brand-text">[ Hyrax<strong>UX</strong> ]</span> </a> </div>
      </div>
    ...
    <div id="mobile_right_sidebar" class="mobile-right-sidebar pull-right">
      <ul class="nav navbar-right top-nav pull-right">
          ...
          <ul class="dropdown-menu alert-dropdown" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
            ...
            <li>
              <div class="streamline message-nicescroll-bar">
                ...
                <hr class="light-grey-hr ma-0"/>
                <div class="sl-item"> <a href="javascript:void(0)">
                  <div class="sl-avatar"> <img class="img-responsive" src="{{ asset('backend') }}/plugins/assets/img/users/avatar-1.jpg" alt="avatar"/> </div>
        ...
        <li class="dropdown auth-drp"> <a href="#" class="dropdown-toggle pr-0" data-toggle="dropdown"><img src="{{ asset(Auth::user()->avator ) }}" alt="user_auth" class="user-auth-img img-circle"/><span class="user-online-status"></span></a>
          <ul class="dropdown-menu user-auth-dropdown" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
            <li> <a href="{{ route('profile') }}"><i class="mdi mdi-account"></i><span>{{ Auth::user()->name }}'s Profile</span></a> </li>
            ...
            <li class="divider"></li>
             <li><a href="{{ route('logout') }}" onclick="event.preventDefault();
               document.getElementById('logout-form').submit();"><i class="mdi mdi-power"></i><span>Log Out</span></a>
