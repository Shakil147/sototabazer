		...
		<div class="container">	
			<div class="w3ls_about_grids">
				...
				<div class="col-md-6 w3ls_about_grid_right">
					<img src="{{ asset('frontend')}}/images/52.jpg" alt=" " class="img-responsive" />
				</div>
				<div class="clearfix"> </div>
			</div>
		</div>
		...
		<div class="container">
			...
			<div class="wthree_team_grids">
				<div class="col-md-3 wthree_team_grid">
					<img src="{{ asset('frontend')}}/images/t4.png" alt=" " class="img-responsive" />
				...
				<div class="col-md-3 wthree_team_grid">
					<img src="{{ asset('frontend')}}/images/t5.png" alt=" " class="img-responsive" />
				...
				<div class="col-md-3 wthree_team_grid">
					<img src="{{ asset('frontend')}}/images/t6.png" alt=" " class="img-responsive" />
				...
				<div class="col-md-3 wthree_team_grid">
					<img src="{{ asset('frontend')}}/images/t7.png" alt=" " class="img-responsive" />
