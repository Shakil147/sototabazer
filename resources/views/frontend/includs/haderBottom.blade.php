                                                    ...
                                                    <ul class="megamenu">
                                                        ...
                                                        <li class="item-vertical  style1 with-sub-menu hover">
                                                            ...
                                                            <a href="#" class="clearfix">
                                                                ...
                                                                <img src="{{ asset('emarket') }}/image/catalog/menu/icons/ico9.png" alt="icon">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="row banner">
                                                                                <a href="#">
                                                                                    <img src="{{ asset('emarket') }}/image/catalog/menu/megabanner/vbanner1.jpg" alt="banner1">
                                                                                    </a>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                            ...
                                                            <li class="item-vertical with-sub-menu hover">
                                                                <p class="close-menu"></p>
                                                                <a href="#" class="clearfix">
                                                                     <img src="{{ asset('emarket') }}/image/catalog/menu/icons/ico7.png" alt="icon">
                                                            ...
                                                            <li class="item-vertical">
                                                                <p class="close-menu"></p>
                                                                <a href="#" class="clearfix">
                                                                     <img src="{{ asset('emarket') }}/image/catalog/menu/icons/ico5.png" alt="icon">
                                                                    <span>Health & Beauty</span>
                                                            ...
                                                            <li class="item-vertical">
                                                                <p class="close-menu"></p>
                                                                <a href="#" class="clearfix">
                                                                     <img src="{{ asset('emarket') }}/image/catalog/menu/icons/ico4.png" alt="icon">
                                                                    <span>Bathroom</span>
                                                                </a>
                                                            </li>
                                                            <li class="item-vertical">
                                                                <p class="close-menu"></p>
                                                                <a href="#" class="clearfix">
                                                                     <img src="{{ asset('emarket') }}/image/catalog/menu/icons/ico3.png" alt="icon">
                                                            ...
                                                            <li class="item-vertical" >
                                                                <p class="close-menu"></p>
                                                                <a href="#" class="clearfix">
                                                                    <img src="{{ asset('emarket') }}/image/catalog/menu/icons/ico2.png" alt="icon">
                                                                    <span>Bedroom</span>
                                                                </a>
                                                            </li>
                                                            <li class="item-vertical" >
                                                            ...
                                                            <li class="item-vertical" style="display: none;">
                                                                <p class="close-menu"></p>
                                                                <a href="#" class="clearfix">
                                                                     <img src="{{ asset('emarket') }}/image/catalog/menu/icons/ico11.png" alt="icon">
                                                            ...
                                                            <li class="item-vertical" style="display: none;">
                                                                <p class="close-menu"></p>
                                                                <a href="#" class="clearfix">
                                                                     <img src="{{ asset('emarket') }}/image/catalog/menu/icons/ico12.png" alt="icon">
                    ...
                    <div class="bottom3 col-lg-3 col-md-3 col-sm-3">
                       ...
                       <div class="shopping_cart">
                            ...
                            /*$grandtotal = $grandtotal+$shippingCost;*/
                                   ...
                                   <span class="items_cart">{{ $gq }}</span><span class="items_cart2"> item(s)</span><span class="items_carts">TK. {{ $grandtotal }}</span>
                                            </span>
                                        </div>
                                    </div>
                                </a>
                                        ...
                                        <table class="table table-striped">
                                            <tbody>
                                                ...
                                                <img src="{{ asset($product->options->image) }}" 
                                                            style="width:70px" alt="{{ $product->name }}" 
                                                            title="{{ $product->name }}" class="preview">
                                                        </a>
                                                    </td>
                                                    <td class="text-left"> 
                                                        <a class="cart_product_name" href="{{ url('/single-product/'.$product->id) }}">
                                                        {{ $product->name }}
                                                        </a> 
                                                    </td>
                                                    <td class="text-center">{{  $product->qty }}</td>
                                                    <td class="text-center">TK. {{ $product->qty*$product->price }}</td>
                                                    <td class="text-right">
                                        ...
                                        <div>
                                            <table class="table table-bordered">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="text-left"><strong>VAT (5%)</strong>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right"><b>TK. {{ $grandtotal }}</b></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            <p class="text-right">
                                             <a class="btn view-cart" href="{{ route('cart.show') }}">
                                                <i class="fa fa-shopping-cart"></i>View Cart</a>&nbsp;&nbsp;&nbsp; 
                                            @if($name = Session::get('customerName'))
                                             <a class="btn btn-mega checkout-cart" href="{{ route('shipping.info') }}">
                                                <i class="fa fa-share"></i>Checkout</a> 
                                            @else

                                            <a class="btn btn-mega checkout-cart" href="{{ route('checkout.login') }}">
                                                <i class="fa fa-share"></i>Checkout</a> 
